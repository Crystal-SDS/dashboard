...
from crystal_dashboard.dashboards.sdscontroller.projects \
...
class IndexView(tables.DataTableView):
    ...
    template_name = 'sdscontroller/projects/index.html'
    ...
    def get_data(self):
        ...
        if policy.check((("sdscontroller", "sdscontroller:list_projects"),),
            ...
            if filter_first.get('sdscontroller.projects', False) and len(
                    filters) == 0:
...
class ProjectUsageView(usage.UsageView):
    ...
    template_name = 'sdscontroller/projects/usage.html'
    csv_response_class = project_views.ProjectUsageCsvRenderer
    csv_template_name = 'sdscontroller/overview/usage.csv'
    ...
    def get_initial(self):
        ...
        try:
            ...
            if keystone.VERSIONS.active >= 3:
                ...
                try:
                    if policy.check((("sdscontroller", "sdscontroller:get_domain"),),
                                    self.request):
...
class DetailProjectView(views.HorizonTemplateView):
    template_name = 'sdscontroller/projects/detail.html'
