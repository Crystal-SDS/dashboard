...
from crystal_dashboard.dashboards.sdscontroller.workload_metrics import forms as wm_forms
from crystal_dashboard.dashboards.sdscontroller.workload_metrics import tabs as wm_tabs


class IndexView(tabs.TabbedTableView):
    tab_group_class = wm_tabs.WorkloadMetricsTabs
    template_name = 'sdscontroller/workload_metrics/index.html'
...
class UploadView(forms.ModalFormView):
    ...
    submit_url = reverse_lazy('horizon:sdscontroller:workload_metrics:upload_metric_module')
    template_name = "sdscontroller/workload_metrics/upload_metric_module.html"
    context_object_name = 'metric_module'
    success_url = reverse_lazy('horizon:sdscontroller:workload_metrics:index')
...
def download_metric_module(request, metric_module_id):
    try:
        ...
        redirect = reverse("horizon:sdscontroller:workload_metrics:index")
...
class UpdateView(forms.ModalFormView):
    ...
    submit_url = "horizon:sdscontroller:workload_metrics:update_metric_module"
    template_name = "sdscontroller/workload_metrics/update_metric_module.html"
    context_object_name = 'metric_module'
    success_url = reverse_lazy('horizon:sdscontroller:workload_metrics:index')
