...
from crystal_dashboard.dashboards.sdscontroller.filters.dependencies import models as dependency_models
from crystal_dashboard.dashboards.sdscontroller.filters.dependencies import tables as dependency_tables
from crystal_dashboard.dashboards.sdscontroller.filters.filters import models as filters_models
from crystal_dashboard.dashboards.sdscontroller.filters.filters import tables as filter_tables
from crystal_dashboard.dashboards.sdscontroller.filters.groups import models as group_models
from crystal_dashboard.dashboards.sdscontroller.filters.groups import tables as group_tables
from crystal_dashboard.dashboards.sdscontroller.filters.registry_dsl import models as registry_models
from crystal_dashboard.dashboards.sdscontroller.filters.registry_dsl import tables as registry_tables
...
class Filters(tabs.TableTab):
    ...
    name = _("Filters")
    slug = "filters_table"
    template_name = "sdscontroller/filters/filters/_detail.html"
    preload = False
