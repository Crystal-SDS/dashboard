...
from crystal_dashboard.dashboards.sdscontroller.filters.registry_dsl import forms as policies_forms
...
class CreateFilterView(forms.ModalFormView):
    ...
    template_name = 'sdscontroller/filters/registry_dsl/create_filter.html'
    success_url = reverse_lazy('horizon:sdscontroller:filters:index')
    page_title = _("Register a Filter")
    submit_label = _("Register")
    submit_url = reverse_lazy(
        "horizon:sdscontroller:filters:registry_dsl:create_filter")
...
class UpdateFilterView(forms.ModalFormView):
    ...
    submit_url = "horizon:sdscontroller:filters:registry_dsl:update_filter"
    template_name = "sdscontroller/filters/registry_dsl/update_filter.html"
