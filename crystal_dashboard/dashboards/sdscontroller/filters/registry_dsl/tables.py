...
class CreateFilter(tables.LinkAction):
    ...
    url = "horizon:sdscontroller:filters:registry_dsl:create_filter"
    classes = ("ajax-modal",)
    icon = "plus"
...
class UpdateFilter(tables.LinkAction):
    ...
    def get_link_url(self, datum=None):
        base_url = reverse("horizon:sdscontroller:filters:registry_dsl:update_filter", kwargs={'name': datum.name})
        return base_url
