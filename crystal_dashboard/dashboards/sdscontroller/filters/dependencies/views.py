...
from crystal_dashboard.dashboards.sdscontroller.filters.dependencies import forms as dependencies_forms
...
class UploadView(forms.ModalFormView):
    ...
    submit_url = reverse_lazy('horizon:sdscontroller:filters:dependencies:upload')
    template_name = "sdscontroller/filters/dependencies/upload.html"
...
class UpdateView(forms.ModalFormView):
    ...
    submit_url = "horizon:sdscontroller:filters:dependencies:update"
    template_name = "sdscontroller/filters/dependencies/update.html"
    context_object_name = 'dependency'
    success_url = reverse_lazy('horizon:sdscontroller:filters:index')
