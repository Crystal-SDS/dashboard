...
from crystal_dashboard.dashboards.sdscontroller.filters.filters import forms as filters_forms
...
class UploadStorletView(forms.ModalFormView):
    ...
    submit_url = reverse_lazy('horizon:sdscontroller:filters:filters:upload_storlet')
    template_name = "sdscontroller/filters/filters/upload_storlet.html"
    context_object_name = 'filter'
    success_url = reverse_lazy('horizon:sdscontroller:filters:index')
...
class UploadNativeView(forms.ModalFormView):
    ...
    submit_url = reverse_lazy('horizon:sdscontroller:filters:filters:upload_native')
    template_name = "sdscontroller/filters/filters/upload_native.html"
    context_object_name = 'filter'
    success_url = reverse_lazy('horizon:sdscontroller:filters:index')
...
class UploadGlobalView(forms.ModalFormView):
    ...
    submit_url = reverse_lazy('horizon:sdscontroller:filters:filters:upload_global')
    template_name = "sdscontroller/filters/filters/upload_global.html"
    context_object_name = 'filter'
    success_url = reverse_lazy('horizon:sdscontroller:filters:index')
...
class UpdateView(forms.ModalFormView):
    ...
    # submit_url = "horizon:sdscontroller:filters:filters:update"
    template_name = "sdscontroller/filters/filters/update.html"
    context_object_name = 'filter'
    success_url = reverse_lazy('horizon:sdscontroller:filters:index')
...
class UpdateStorletView(UpdateView):
    ...
    submit_url = "horizon:sdscontroller:filters:filters:update_storlet"


class UpdateNativeView(UpdateView):
    form_class = filters_forms.UpdateNativeFilter
    submit_url = "horizon:sdscontroller:filters:filters:update_native"


class UpdateGlobalView(UpdateView):
    form_class = filters_forms.UpdateGlobalFilter
    submit_url = "horizon:sdscontroller:filters:filters:update_global"
