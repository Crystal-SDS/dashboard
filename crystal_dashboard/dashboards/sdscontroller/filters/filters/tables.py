...
class UploadStorletFilter(UploadFilter):
    ...
    url = "horizon:sdscontroller:filters:filters:upload_storlet"


class UploadNativeFilter(UploadFilter):
    verbose_name = _("Upload Native Filter")
    url = "horizon:sdscontroller:filters:filters:upload_native"


class UploadGlobalFilter(UploadFilter):
    verbose_name = _("Upload Global Native Filter")
    url = "horizon:sdscontroller:filters:filters:upload_global"
...
class DownloadFilter(tables.LinkAction):
    ...
    def get_link_url(self, datum=None):
        base_url = reverse('horizon:sdscontroller:filters:filters:download', kwargs={'filter_id': datum.id})
        return base_url
...
class DeleteFilter(tables.DeleteAction):
    ...
    name = "delete_filter"
    success_url = "horizon:sdscontroller:filters:index"
...
class UpdateStorletFilter(UpdateFilter):
    def get_link_url(self, datum=None):
        base_url = reverse("horizon:sdscontroller:filters:filters:update_storlet", kwargs={'filter_id': datum.id})
        return base_url


class UpdateNativeFilter(UpdateFilter):
    def get_link_url(self, datum=None):
        base_url = reverse("horizon:sdscontroller:filters:filters:update_native", kwargs={'filter_id': datum.id})
        return base_url


class UpdateGlobalFilter(UpdateFilter):
    def get_link_url(self, datum=None):
        base_url = reverse("horizon:sdscontroller:filters:filters:update_global", kwargs={'filter_id': datum.id})
        return base_url
