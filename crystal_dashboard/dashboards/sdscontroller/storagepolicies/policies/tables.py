...
class CreateSimplePolicy(tables.LinkAction):
    ...
    url = "horizon:sdscontroller:storagepolicies:policies:create_simple_policy"
    classes = ("ajax-modal",)
    icon = "plus"
...
class CreatePolicyDSL(tables.LinkAction):
    ...
    url = "horizon:sdscontroller:storagepolicies:policies:create_dsl_policy"
    classes = ("ajax-modal",)
    icon = "plus"
...
class UpdateStaticPolicy(tables.LinkAction):
    ...
    def get_link_url(self, datum=None):
        base_url = reverse("horizon:sdscontroller:storagepolicies:policies:update_static_policy", kwargs={'policy_id': datum.id})
        return base_url
