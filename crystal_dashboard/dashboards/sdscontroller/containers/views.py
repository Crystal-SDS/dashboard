...
class ContainerView(browsers.ResourceBrowserView):
    ...
    template_name = "sdscontroller/containers/index.html"
...
class CreateView(forms.ModalFormView):
    ...
    template_name = 'sdscontroller/containers/create.html'
...
class CreatePseudoFolderView(forms.ModalFormView):
    ...
    template_name = 'sdscontroller/containers/create_pseudo_folder.html'
    success_url = "horizon:sdscontroller:containers:index"
...
class UploadView(forms.ModalFormView):
    ...
    template_name = 'sdscontroller/containers/upload.html'
    success_url = "horizon:sdscontroller:containers:index"
...
def object_download(request, container_name, object_path):
    try:
        ...
        redirect = reverse("horizon:sdscontroller:containers:index")
...
class CopyView(forms.ModalFormView):
    ...
    template_name = 'sdscontroller/containers/copy.html'
    success_url = "horizon:sdscontroller:containers:index"
...
class ContainerDetailView(forms.ModalFormMixin, generic.TemplateView):
    template_name = 'sdscontroller/containers/container_detail.html'
...
class ObjectDetailView(forms.ModalFormMixin, generic.TemplateView):
    template_name = 'sdscontroller/containers/object_detail.html'
...
class UpdateObjectView(forms.ModalFormView):
    ...
    template_name = 'sdscontroller/containers/update.html'
    success_url = "sdscontroller:sdscontroller:containers:index"
