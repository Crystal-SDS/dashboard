...
from crystal_dashboard.dashboards.sdscontroller.nodes import forms as nodes_forms
from crystal_dashboard.dashboards.sdscontroller.nodes import tabs as nodes_tabs


class IndexView(tabs.TabbedTableView):
    tab_group_class = nodes_tabs.NodesTabs
    template_name = 'sdscontroller/nodes/index.html'
    page_title = _("Nodes")
...
class UpdateNodeView(forms.ModalFormView):
    ...
    submit_url = "horizon:sdscontroller:nodes:update"
    template_name = "sdscontroller/nodes/update.html"
    context_object_name = 'node'
    success_url = reverse_lazy('horizon:sdscontroller:nodes:index')
