...
class CreateGETController(tables.LinkAction):
    ...
    url = "horizon:sdscontroller:bandwidth_differentiation:controllers:create_get_controller"
    classes = ("ajax-modal",)
    icon = "plus"
...
class CreatePUTController(tables.LinkAction):
    name = "create_put"
    verbose_name = _("Create Controller")
    url = "horizon:sdscontroller:bandwidth_differentiation:controllers:create_put_controller"
    classes = ("ajax-modal",)
    icon = "plus"
...
class CreateReplicationController(tables.LinkAction):
    ...
    verbose_name = _("Create Controller")
    url = "horizon:sdscontroller:bandwidth_differentiation:controllers:create_replication_controller"
    classes = ("ajax-modal",)
    icon = "plus"
