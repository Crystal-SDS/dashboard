...
from crystal_dashboard.dashboards.sdscontroller.sds_policies.metrics import models as metrics_models
from crystal_dashboard.dashboards.sdscontroller.sds_policies.metrics import tables as metrics_tables
from crystal_dashboard.dashboards.sdscontroller.sds_policies.policies import models as policies_models
from crystal_dashboard.dashboards.sdscontroller.sds_policies.policies import tables as policies_tables
from crystal_dashboard.dashboards.sdscontroller.sds_policies.object_types import models as object_types_models
from crystal_dashboard.dashboards.sdscontroller.sds_policies.object_types import tables as object_types_tables
...
class Policies(tabs.TableTab):
    ...
    name = _("Policies")
    slug = "policies_table"
    template_name = "sdscontroller/sds_policies/policies/_detail.html"
    preload = False
