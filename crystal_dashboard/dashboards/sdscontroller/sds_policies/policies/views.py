...
from crystal_dashboard.dashboards.sdscontroller.sds_policies.policies import forms as policies_forms
...
class CreateSimplePolicyView(forms.ModalFormView):
    ...
    submit_url = reverse_lazy("horizon:sdscontroller:sds_policies:policies:create_simple_policy")
    template_name = 'sdscontroller/sds_policies/policies/create_simple_policy.html'
    content_object_name = 'policy'
    success_url = reverse_lazy('horizon:sdscontroller:sds_policies:index')
...
class CreateDSLPolicyView(forms.ModalFormView):
    ...
    submit_label = _("Create")
    submit_url = reverse_lazy("horizon:sdscontroller:sds_policies:policies:create_dsl_policy")
    template_name = 'sdscontroller/sds_policies/policies/create_dsl_policy.html'
    content_object_name = 'policy'
    success_url = reverse_lazy('horizon:sdscontroller:sds_policies:index')
...
class UpdateStaticPolicyView(forms.ModalFormView):
    ...
    submit_url = "horizon:sdscontroller:sds_policies:policies:update_static_policy"
    template_name = "sdscontroller/sds_policies/policies/update_static_policy.html"
