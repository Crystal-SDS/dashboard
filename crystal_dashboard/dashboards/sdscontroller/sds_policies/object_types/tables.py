...
from crystal_dashboard.dashboards.sdscontroller.sds_policies.object_types.models import ObjectType
...
class CreateObjectType(tables.LinkAction):
    ...
    url = "horizon:sdscontroller:sds_policies:object_types:create"
    classes = ("ajax-modal",)
    icon = "plus"
...
class UpdateObjectType(tables.LinkAction):
    ...
    def get_link_url(self, datum=None):
        base_url = reverse("horizon:sdscontroller:sds_policies:object_types:update", kwargs={'object_type_id': datum.id})
        return base_url
...
class DeleteObjectType(tables.DeleteAction):
    ...
    success_url = "horizon:sdscontroller:sds_policies:index"
    ...
    def delete(self, request, obj_id):
        try:
            ...
            redirect = reverse("horizon:sdscontroller:sds_policies:index")
