...
class IndexView(views.APIView):
    template_name = 'crystal/swift_monitoring/system/_swift_project_plots.html'
...
class SwiftContainerView(views.APIView):
    template_name = 'crystal/swift_monitoring/system/_swift_container_plots.html'
...
class SystemView(views.APIView):
    template_name = 'crystal/swift_monitoring/system/_system_plots.html'
