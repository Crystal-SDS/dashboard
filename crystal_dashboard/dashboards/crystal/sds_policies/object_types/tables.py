...
from crystal_dashboard.dashboards.crystal.sds_policies.object_types.models import ObjectType
...
class CreateObjectType(tables.LinkAction):
    ...
    url = "horizon:crystal:sds_policies:object_types:create"
    classes = ("ajax-modal",)
    icon = "plus"
...
class UpdateObjectType(tables.LinkAction):
    ...
    def get_link_url(self, datum=None):
        base_url = reverse("horizon:crystal:sds_policies:object_types:update", kwargs={'object_type_id': datum.id})
        return base_url
...
class DeleteObjectType(tables.DeleteAction):
    ...
    success_url = "horizon:crystal:sds_policies:index"
