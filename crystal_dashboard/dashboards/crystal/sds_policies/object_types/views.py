...
class CreateObjectTypeView(forms.ModalFormView):
    ...
    template_name = 'crystal/sds_policies/object_types/create.html'
    success_url = reverse_lazy('horizon:crystal:sds_policies:index')
    page_title = _("Create an Object Type")
    submit_label = _("Create")
    submit_url = reverse_lazy("horizon:crystal:sds_policies:object_types:create")
...
class UpdateObjectTypeView(forms.ModalFormView):
    ...
    submit_url = "horizon:crystal:sds_policies:object_types:update"
    template_name = "crystal/sds_policies/object_types/update.html"
