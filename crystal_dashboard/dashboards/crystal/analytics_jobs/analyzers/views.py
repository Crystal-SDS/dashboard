...
class CreateAnalyzerView(forms.ModalFormView):
    ...
    template_name = 'crystal/analytics_jobs/analyzers/create.html'
    success_url = reverse_lazy('horizon:crystal:analytics_jobs:index')
    page_title = _("Upload an Analyzer")
    submit_label = _("Upload")
    submit_url = reverse_lazy(
        "horizon:crystal:analytics_jobs:analyzers:create_analyzer")
