...
class UploadMetricModule(tables.LinkAction):
    ...
    url = "horizon:crystal:workload_metrics:upload_metric_module"
    classes = ("ajax-modal",)
    icon = "upload"
...
class DownloadMetricModule(tables.LinkAction):
    ...
    def get_link_url(self, datum=None):
        base_url = reverse('horizon:crystal:workload_metrics:download_metric_module', kwargs={'metric_module_id': datum.id})
        return base_url
...
class DeleteMetricModule(tables.DeleteAction):
    ...
    success_url = "horizon:crystal:workload_metrics:index"
...
class UpdateMetricModule(tables.LinkAction):
    ...
    def get_link_url(self, datum=None):
        base_url = reverse("horizon:crystal:workload_metrics:update_metric_module", kwargs={'metric_module_id': datum.id})
        return base_url
