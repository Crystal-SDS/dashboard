...
from crystal_dashboard.dashboards.crystal.bandwidth_differentiation.controllers import urls as controllers_urls
from crystal_dashboard.dashboards.crystal.bandwidth_differentiation.proxy_sorting import urls as proxy_sorting_urls
