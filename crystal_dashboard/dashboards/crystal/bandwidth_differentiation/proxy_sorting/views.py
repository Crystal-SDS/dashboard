...
from crystal_dashboard.dashboards.crystal.bandwidth_differentiation.proxy_sorting import forms as proxy_sorting_forms
...
class UploadView(forms.ModalFormView):
    ...
    submit_url = reverse_lazy('horizon:crystal:bandwidth_differentiation:proxy_sorting:upload')
    template_name = "crystal/bandwidth_differentiation/proxy_sorting/upload.html"
...
class UpdateView(forms.ModalFormView):
    ...
    submit_url = "horizon:crystal:bandwidth_differentiation:proxy_sorting:update"
    template_name = "crystal/bandwidth_differentiation/proxy_sorting/update.html"
    context_object_name = 'proxy_sorting'
    success_url = reverse_lazy('horizon:crystal:bandwidth_differentiation:index')
