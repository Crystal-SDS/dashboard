...
class CreateSortedMethod(tables.LinkAction):
    ...
    url = "horizon:crystal:bandwidth_differentiation:proxy_sorting:upload"
    classes = ("ajax-modal",)
    icon = "plus"
...
class UpdateSortedMethod(tables.LinkAction):
    ...
    def get_link_url(self, proxy_sorting):
        base_url = reverse("horizon:crystal:bandwidth_differentiation:proxy_sorting:update", kwargs={'proxy_sorting_id': proxy_sorting.id})
        return base_url
