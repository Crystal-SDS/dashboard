...
class CreateSLA(tables.LinkAction):
    ...
    url = "horizon:crystal:bandwidth_differentiation:slas:create_sla"
    classes = ("ajax-modal",)
    icon = "plus"
...
class UpdateSLA(tables.LinkAction):
    ...
    def get_link_url(self, datum=None):
        base_url = reverse("horizon:crystal:bandwidth_differentiation:slas:update_sla", kwargs={"sla_id": datum.id})
        return base_url
