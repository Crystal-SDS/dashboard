...
ADD_USER_URL = "horizon:crystal:projects:create_user"
...
COMMON_HORIZONTAL_TEMPLATE = "crystal/projects/_common_horizontal_form.html"
    ...
    def _create_project(self, request, data):
        ...
        try:
            ...
            self.object = api.keystone.tenant_create(request,
                                                     ...
                                                     **kwargs)
            if data['sds_project']:
                sds_api.enable_sds(request, data['name'])
...
class UpdateProjectInfoAction(CreateProjectInfoAction):
    ...
    def __init__(self, request, initial, *args, **kwargs):
        ...
        initial['sds_project'] = sds_api.is_sds_project(initial['name'])
