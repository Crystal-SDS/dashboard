...
class ContainerView(browsers.ResourceBrowserView):
    ...
    template_name = "crystal/containers/index.html"
...
class CreateView(forms.ModalFormView):
    ...
    template_name = 'crystal/containers/create.html'
...
class UploadView(forms.ModalFormView):
    ...
    template_name = 'crystal/containers/upload.html'
    success_url = "horizon:crystal:containers:index"
...
class CopyView(forms.ModalFormView):
    ...
    template_name = 'crystal/containers/copy.html'
    success_url = "horizon:crystal:containers:index"
...
class ContainerDetailView(forms.ModalFormMixin, generic.TemplateView):
    template_name = 'crystal/containers/container_detail.html'
...
class ObjectDetailView(forms.ModalFormMixin, generic.TemplateView):
    template_name = 'crystal/containers/object_detail.html'
...
class UpdateObjectView(forms.ModalFormView):
    ...
    template_name = 'crystal/containers/update.html'
    success_url = "horizon:crystal:containers:index"
