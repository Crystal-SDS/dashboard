...
urlpatterns = [
    ...
    url(r'^create_dynamic_policy/$', views.CreateDynamicPolicyView.as_view(), name='create_dynamic_policy'),
    ...
    url(r'^get_users_by_project/$', views.get_users_by_project, name='get_users_by_project'),
]
